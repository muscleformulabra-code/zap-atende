          ...
          <>
            ...
            <div className="relative border-t border-gray-200 bg-white p-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={send} disabled={sending || !text.trim()} className="rounded-full bg-emerald-500 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-600 disabled:opacity-50">enviar</button>
              </div>
            </div>
          </>
        )}
